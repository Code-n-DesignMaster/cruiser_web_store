                ...
                <div class="check-product">
                        ...
                        <div class="table-products table-products-items"
                            ...
                            <div class="post post-5 product-container">
                                <div class="item item-qty">
                                    <div class="all-center item-shop-basket-count pointer"
                                         @click="toggleQty(item, '-')">
                                        -
                                    </div>
                    ...
                    <div class="container-shipping">
                        <div class="shipping">
                            ...
                            <div>total weigth: {{total_weight.toFixed(2)}}</div>
                        </div>
                        <div class="shipping-checkbox table">
                            <div class="postt">
                                <div class="styled-input-single d-flex align-items-center" style="margin-left: 8px">
                                    <input type="radio" id="simple1"
                                           :checked="data.simple1.select"
                                           name="fieldset-1" @click="active('simple1')"/>
                            ...
                            <div class="postt">
                                ...
                                <div class="styled-input-single d-flex align-items-center" style="margin-left: 8px">
                                    <input type="radio" id="simple2"
                                           :checked="data.simple2.select"
                                           name="fieldset-1" @click="active('simple2')"/>
                            ...
                            <div class="postt">
                                ...
                                <div class="styled-input-single d-flex align-items-center" style="margin-left: 8px">
                                    <input type="radio"
                                           id="simple3"
                                           :checked="data.simple3.select"
                                           name="fieldset-1" @click="active('simple3')"/>
                            ...
                            <div class="postt">
                                ...
                                <div class="styled-input-single d-flex align-items-center" style="margin-left: 8px">
                                    <input type="radio" id="simple4"
                                           :checked="data.simple4.select"
                                           name="fieldset-1" @click="active('simple4')"/>
                            ...
                            <div class="postt">
                                ...
                                <div class="styled-input-single d-flex align-items-center" style="margin-left: 8px">
                                    <input type="radio" id="simple5"
                                           :checked="data.simple5.select"
                                           name="fieldset-1" @click="active('simple5')"/>
                            ...
                            <div class="postt">
                                ...
                                <div class="styled-input-single d-flex align-items-center" style="margin-left: 8px">
                                    <input type="radio" id="simple6"
                                           :checked="data.simple6.select"
                                           name="fieldset-1" @click="active('simple6')"/>
                            ...
                            <div style="position: relative">
                                ...
                                <svg width="51" height="16" viewBox="0 0 51 16" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M47.0897 0.86731H43.9766C43.0097 0.86731 42.2905 1.13165 41.8656 2.09939L35.8828 15.7041H40.1141C40.1141 15.7041 40.8044 13.8747 40.9608 13.4741C41.4241 13.4741 45.5352 13.4803 46.1207 13.4803C46.2409 13.9986 46.6119 15.7041 46.6119 15.7041H50.35L47.0897 0.86731ZM42.1201 10.4356C42.4516 9.58332 43.7253 6.2867 43.7253 6.2867C43.7036 6.32728 44.0538 5.42823 44.2621 4.86946L44.5337 6.14937C44.5337 6.14937 45.3058 9.69362 45.4674 10.4356H42.1201Z"
                                          fill="#2566AF"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M20.6248 0.850708L18.1055 15.6958H22.1348L24.6562 0.850708H20.6248Z"
                                          fill="#2566AF"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M14.7261 0.867341L10.7798 10.9913L10.359 9.46264C9.58072 7.62081 7.37125 4.97563 4.77734 3.30861L8.38583 15.6885L12.6493 15.6812L18.9948 0.864258L14.7261 0.867341Z"
                                          fill="#2566AF"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M8.83174 1.92984C8.59755 1.02557 7.91874 0.756026 7.07618 0.723755H0.829188L0.777344 1.01934C5.63883 2.2035 8.85563 5.05673 10.1904 8.48766L8.83174 1.92984Z"
                                          fill="#E6A540"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M32.8265 3.69674C34.1447 3.67592 35.1002 3.96519 35.8422 4.2649L36.2059 4.43662L36.7511 1.21909C35.9531 0.918358 34.7022 0.595825 33.1415 0.595825C29.1599 0.595825 26.3535 2.60932 26.3317 5.49485C26.3059 7.62707 28.3308 8.81746 29.8605 9.52819C31.4305 10.2566 31.957 10.7197 31.9497 11.37C31.9373 12.3638 30.6978 12.8196 29.5402 12.8196C27.9267 12.8196 27.0696 12.5959 25.7462 12.0423L25.2271 11.8051L24.6602 15.1277C25.6032 15.5428 27.3432 15.8998 29.1496 15.9185C33.385 15.9185 36.1375 13.9289 36.1666 10.8456C36.1842 9.15878 35.1095 7.87159 32.7808 6.81536C31.3715 6.12654 30.5093 5.66863 30.5175 4.97351C30.5175 4.35648 31.2491 3.69674 32.8265 3.69674Z"
                                          fill="#2566AF"/>
                                </svg>
                                <svg width="32" height="19" viewBox="0 0 32 19" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M9.76553 0.00012207C14.9884 0.00012207 19.2225 4.24899 19.2225 9.49024C19.2225 14.7315 14.9884 18.9803 9.76553 18.9803C4.54264 18.9803 0.308594 14.7315 0.308594 9.49024C0.308594 4.24899 4.54264 0.00012207 9.76553 0.00012207Z"
                                          fill="#EA001B"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M21.5858 0.00012207C26.8088 0.00012207 31.0428 4.24899 31.0428 9.49024C31.0428 14.7315 26.8088 18.9803 21.5858 18.9803C16.3629 18.9803 12.1289 14.7315 12.1289 9.49024C12.1289 4.24899 16.3629 0.00012207 21.5858 0.00012207Z"
                                          fill="#F3C421"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M12.0586 9.45425C12.0586 12.4693 13.4584 15.1559 15.6407 16.8953C17.823 15.1558 19.2229 12.4693 19.2229 9.45425C19.2229 6.43916 17.8231 3.75258 15.6407 2.01318C13.4584 3.75273 12.0586 6.43922 12.0586 9.45425Z"
                                          fill="#FF5F01"/>
                                </svg>
    ...
    export default {
        ...
        created() {
            ...
            try{
                ...
                this.setUser({
                    target: {
                        value: data.country && data.country.code ? data.country.code : ''
                    }
                }, this.dataRegister, 'country');
                this.setUser({
                    target: {value: data.postal_code ? data.postal_code : ''}
                    ...
                    Products.staticgetCareer(this.dataRegister, this.items)
                        .then(res => {
                            ...
                            localStorage.setItem('data', JSON.stringify({
                                data:this.data,
                                postal_code:this.dataRegister.postal_code,
